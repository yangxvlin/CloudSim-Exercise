 ...
 * Xulin Yang, 904904
 *
 * @create 2021-02-03 19:30
 * description:
 **/

public class DatacenterBrokerSJF extends SimEntity {
     ...
     * @post $none
     */
    public DatacenterBrokerSJF(String name) throws Exception {
        super(name);
    ...
    protected void submitCloudlets() {
        ...
        // ************************** modification start ***********************
        Comparator<Cloudlet> cc = (Cloudlet a, Cloudlet b) -> (int) (a.getCloudletLength() - b.getCloudletLength());
        List<Cloudlet> sortedList = new ArrayList<>(getCloudletList());
        sortedList.sort(cc);

        int cloudletID = 0;
        for (Cloudlet cloudlet: sortedList) {
            Log.printLine("ID: " + cloudletID +
